...
def init_distributed_mode(cfg: DINOV1Config):
    ...
    if "RANK" in os.environ and "WORLD_SIZE" in os.environ:
        ...
        assert ValueError(
            "I commented out python and submitit submissions. Uncomment and fix if you want to use those."
        )
    ...
    print(
        "| distributed init (rank {}): {}".format(cfg.train.rank, cfg.train.dist_url),
        flush=True,
    )
    dist.barrier()
...
class MultiCropWrapper(nn.Module):
    ...
    def forward(self, x, channel_ids_list, channel_masks):
        ...
        for end_idx in idx_crops:
            ...
            _out = self.backbone(
                combined_images,
                channel_ids_list * repeat_multiplier,
                channel_masks * repeat_multiplier,
            )
