...
if __name__ == "__main__":
    ...
    parser.add_argument('--pkl_path', type=str, help='Path to the pickle file containing embeddings')
    parser.add_argument('--output_folder', type=str, default='', help='Folder to save results')
