...
python -m torch.distributed.launch --nproc_per_node=8 main_mae.py --data_path /scr/data/CHAMMI-75_small.zip --output_dir /scr/vidit/Models/MAE_CHANViT_10ds --batch_size_per_gpu 32 --num_workers 4 --epochs 100 --metadata_path /scr/data/CHAMMI-75_small_metadata.csv --dataset_filter 10ds --guided_crops_path /scr/data/CHAMMI-75_guidance --guided_cropping True
